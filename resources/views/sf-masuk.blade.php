                        ...
                        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                            ...
                            <div class="d-flex align-items-center gap-2 flex-wrap">
                                ...
                                <div class="btn-group shadow-sm" style="border-radius: 20px; overflow: hidden;">
                                    ...
                                    <a href="{{ url('form/form-sfmasuk') }}" class="btn btn-primary btn-sm border-0 font-weight-bold">
    ...
    <script>
        $(function() {
            ...
            @if (auth()->user()->username === 'admin_cluster')
                ...
                ========================== */
                // Update "Check All" state when table is redrawn (page change / filter change)
                ...
                $('#btnBulkDelete').on('click', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                url: "{{ route('sf-masuk.bulk-delete') }}",
                                type: "POST",
                                data: {
                                    _token: "{{ csrf_token() }}",
                                    ids: selectedIds
                                ...
                                success: function(res) {
                                    if (res.success) {
                                        ...
                                        selectedIds = []; // Reset memory selection
