							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title">Barang Keluar SF (Penjualan)</h4>  
										<a href="{{ url('form/form-sfkeluar') }}"  class="btn btn-primary btn-round ml-auto">
								...
								<div class="card-body">
									<div class="col-auto mb-3">
										<a href="/exportsfkeluar?bulan={{ request('bulan') }}&tahun={{ request('tahun') }}" class="btn btn-success btn-sm btn-rounded">
										...
										<table id="add-row" class="display table table-striped table-hover" >
											...
											<tbody>
												...
												<tr>
													...
													<td> {{ $row -> idtap }}</td>
													<td> {{ $row -> namasf }}</td>
													<td> {{ $row -> tambahanket }}</td>
													<td>
														@if (session('idtap') == 'SBP_DUMAI')
														<button class="btn btn-danger btn-round ml-auto btn-sm" data-toggle="modal" data-target="#addRowModal{{ $row -> idkeluar }}">
															<i class="fa fa-trash"></i>
															Delete
														</button>
															
														@else
														<button class="btn btn-danger btn-round ml-auto btn-sm" data-toggle="modal" data-target="#addRowModal{{ $row -> idkeluar }}" disabled>
															<i class="fa fa-trash"></i>
															Delete
														</button>
									...
									<div class="modal fade" id="addRowModal{{ $row -> idkeluar }}" role="dialog" aria-hidden="true">
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<div class="modal-body">
													<form action="sf-keluar/{{ $row -> idkeluar }}" method="post">
														@csrf
