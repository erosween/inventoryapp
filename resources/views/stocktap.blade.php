                        ...
                        <div class="card">
                            <div class="card-header">
                                <ul class="nav nav-pills nav-secondary" id="pills-tab" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link active" href="{{ url('stocktap') }}" role="tab">Stock Tap</a>
                                    </li>
                                    <li class="nav-item">
                            ...
                            <div class="card-body">
                                <div class="col-auto mb-3">
                                    <a href="{{ url('exportexceltap') }}" class="btn btn-success btn-sm btn-rounded"><i
                                    ...
                                    <table id="stock" class="display table table-striped table-hover">
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <td><strong>{{ number_format($tV63) }}</strong></td>
