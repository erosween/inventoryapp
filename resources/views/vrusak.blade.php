                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="col-auto mb-3">
                                    <a href="/exportrusak?bulan={{ request('bulan') }}&tahun={{ request('tahun') }}"
                                ...
                                <div class="table-responsive">
                                                    ...
                                                    <td>
                                                        @if (session('idtap') == 'SBP_DUMAI')
                                                            <button class="btn btn-danger btn-round ml-auto btn-sm"
                                                                data-toggle="modal"
                                                                data-target="#addRowModal{{ $row->idrusak }}">
                                                        ...
                                                        @else
                                                            <button class="btn btn-danger btn-round ml-auto btn-sm"
                                                                data-toggle="modal"
                                                                data-target="#addRowModal{{ $row->idrusak }}" disabled>
                                                                <i class="fa fa-trash"></i>
                                                                Delete
                                                            </button>
                                                        @endif
                                    ...
                                    <!-- Modal -->
                                    @foreach ($data as $row)
                                        <div class="modal fade" id="addRowModal{{ $row->idrusak }}" role="dialog"
                                            aria-hidden="true">
