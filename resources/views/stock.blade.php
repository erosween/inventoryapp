                ...
                <div class="card premium-card stock-card">
                    ...
                    <div class="card-header bg-white border-bottom py-3">
                        <ul class="nav nav-pills nav-secondary nav-pills-no-bd d-flex align-items-center gap-2">
                            <li class="nav-item">
                                <a class="nav-link {{ request()->is('stock') ? 'active' : '' }} font-weight-bold shadow-sm" href="{{ url('stock') }}" style="border-radius: 20px;">
                    ...
                    <div class="card-body px-0 py-0">
                        ...
                        <div class="table-scroll stock-freeze stock-freeze--two">
                                        ...
                                        @foreach ($groups as $voucherType => $validityGroups)
                                            ...
                                            @foreach ($validityGroups as $groupName => $items)
                                                <th colspan="{{ count($items) + 1 }}"
                                                    ...
                                                    <span class="validity-label">{{ $groupName }}</span>
                                                </th>
                                            @endforeach
                                        @endforeach
                                    </tr>
