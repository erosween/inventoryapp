                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="col-auto mb-3">
                                    <a href="/exportretursf?bulan={{ request('bulan') }}&tahun={{ request('tahun') }}"
                                ...
                                <div class="table-responsive">
                                                    ...
                                                    <td>
                                                        @if (session('idtap') == 'SBP_DUMAI')
                                                            <button class="btn btn-danger btn-round ml-auto btn-sm"
                                                                data-toggle="modal"
                                                                data-target="#addRowModal{{ $row->idretur }}">
                                                        ...
                                                        @else
                                                            <button class="btn btn-danger btn-round ml-auto btn-sm"
                                                                data-toggle="modal"
                                                                data-target="#addRowModal{{ $row->idretur }}" disabled>
                                                                <i class="fa fa-trash"></i>
                                                                Delete
                                                            </button>
                                                        @endif
                                    ...
                                    <!-- Modal -->
                                    @foreach ($data as $row)
                                        <div class="modal fade" id="addRowModal{{ $row->idretur }}" role="dialog"
                                            aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="exportretursf/{{ $row->idretur }}" method="post">
                                                            ...
                                                            <h5>Apakah anda yakin akan menghapus stok
                                                                ...
                                                                <strong>{{ number_format($row->qty) }}</strong> dari Sales
                                                                <strong>{{ $row->namasf }}</strong></h5>
                                                            ...
                                                            <input type="hidden" name="idsf"
                                                                value="{{ $row->idsf }}" class="form-control mb-1">
