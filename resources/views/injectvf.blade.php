                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex align-items-center">
                                    ...
                                    <a class="btn btn-danger btn-round dropdown-toggle ml-auto" href="#"
                            ...
                            <div class="card-body">
                                <div class="col-auto mb-3">
                                    <a href="/exportinject?bulan={{ request('bulan') }}&tahun={{ request('tahun') }}"
                                ...
                                <div class="table-responsive">
                                                    ...
                                                    <td>
                                                        ...
                                                        @if (session('idtap') == 'SBP_DUMAI')
                                                            <button class="btn btn-danger btn-round ml-auto btn-sm"
                                                                data-toggle="modal"
                                                                data-target="#addRowModal{{ $row->idinject }}">
                                                        ...
                                                        @else
                                                            <button class="btn btn-danger btn-round ml-auto btn-sm"
                                                                data-toggle="modal"
                                                                data-target="#addRowModal{{ $row->idinject }}" disabled>
                                                                <i class="fa fa-trash"></i>
                                                                Delete
                                                            </button>
                                                        @endif
                                    ...
                                    {{-- modal delet --}}
                                    @foreach ($data as $row)
                                        <div class="modal fade" id="addRowModal{{ $row->idinject }}" role="dialog"
                                            aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="injectvf/{{ $row->idinject }}" method="post">
                                                            ...
                                                            <input type="hidden" name="kategori"
                                                                value="{{ $row->kategori }}" class="form-control mb-1">
