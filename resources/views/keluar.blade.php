                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="col-auto mb-3">
                                    <a href="/exporttap?bulan={{ request('bulan') }}&tahun={{ request('tahun') }}"
                                        ...
                                        <tbody>
                                            @foreach ($data as $row)
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($row->status == 0)
                                                            <span class="btn btn-success btn-round btn-sm"
                                                                data-toggle="modal" disabled> Approved</span>
                                                        @else
                                                            <span class="btn btn-warning btn-round btn-sm"
                                                                data-toggle="modal" disabled> Wait for Approval</span>
                                                        @endif
                                                    </td>
                                                </tr>
                                            @endforeach
