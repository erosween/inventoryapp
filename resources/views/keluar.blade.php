							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title">Barang Keluar TAP</h4>  
										<a href="{{ url('form/formkeluartap') }}"  class="btn btn-primary btn-round ml-auto">
							...
							{{-- card-header --}}
								<div class="card-body">
									<div class="col-auto mb-3">
										<a href="/exporttap?bulan={{ request('bulan') }}&tahun={{ request('tahun') }}" class="btn btn-success btn-sm btn-rounded">
										...
										<table id="add-row" class="display table table-striped table-hover" >
											...
											<tbody>
												...
												<tr>
													...
													<td>
														@if($row->status == 0)
															<span class="btn btn-success btn-round btn-sm" data-toggle="modal" disabled> Approved</span>
														@else
															<span class="btn btn-warning btn-round btn-sm" data-toggle="modal" disabled> Wait for Approval</span>
														@endif
													</td>
												</tr>
												@endforeach
											...
											<div class="modal fade" id="addRowModal{{ $row -> idkeluar }}" role="dialog" aria-hidden="true">
												<div class="modal-dialog" role="document">
													<div class="modal-content">
														...
														<div class="modal-body">
															<form action="keluar/{{ $row -> idkeluar }}" method="post">
																@csrf
																...
																<input type="hidden" name="pengirim" value="{{ $row -> pengirim }}" class="form-control mb-1">
