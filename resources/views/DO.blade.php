                ...
                <div class="card premium-card">
                        ...
                        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                            <div>
                                <h4 class="card-title mb-0 font-weight-bold text-indigo">
                                    <i class="fas fa-file-invoice mr-2"></i>Input DO TAP
                                </h4>
                                <div class="text-muted small">Monitoring penerimaan Delivery Order (DO) dari distributor pusat</div>
                            </div>
                            ...
                            <div class="d-flex align-items-center gap-2 flex-wrap">
                                ...
                                <div class="btn-group shadow-sm" style="border-radius: 20px; overflow: hidden;">
                                    ...
                                    {{-- Tambah --}}
                                    <a href="{{ url('form/formDO') }}" class="btn btn-primary btn-sm border-0 font-weight-bold">
                    ...
                    <div class="card-body px-0 py-0">
                        <div class="table-responsive">
                            <table id="do-table" class="table table-indigo table-hover w-100 mb-0">
                                <thead>
                                    <tr>
